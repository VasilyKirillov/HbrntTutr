...
public class AddressRepository {
    ...
    public void init() throws SQLException {
        ...
        try {
            ...
            try {
                stmt.execute("CREATE TABLE address (id integer generated by default as identity primary key,"
                        + " street VARCHAR(50), city VARCHAR(30), state VARCHAR(30), zip VARCHAR(10))");
            } finally {
                stmt.close();
            }            
        } finally {
